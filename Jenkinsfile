pipeline {
    ...
    stages {
        ...
        stage('Test Application') {
            ...
            slackSend botUser: true, channel: 'security', color: '#ff0000', message: '21 Critical 15 High Vulnerability Detected ', teamDomain: 'futurama', tokenCredentialId: 'slack-token', username: 'jenkins'        
    }
