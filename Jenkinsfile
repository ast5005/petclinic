pipeline {
    ...
    stages {
        ...
        stage('Test Application') {
            ...
            slackSend botUser: true, channel:'security', color:'#00ff00',message:'21 Critical 17 High Vulnarability Detected',tokenCredentialId: 'slack-token', <$BUILD_URL|Build #$BUILD_NUMBER>:'21 Critical 17 High Vulnarability Detected'          
